...
public class AngleAdapter extends BaseAdapter {
    ...
    public AngleAdapter(Context context, List<Angle> listData) {
        mContext = context;
        mListItem = listData;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.angle_list_item, null);
        ...
        holder.infoLen1.setText(String.valueOf(angle.getAngle()));
        holder.infoLen2.setText(String.valueOf(angle.getThickness()));
        return convertView;
    }
